...
if [ ! -d "$TARGET_DIR/x86" ]; then
  PATH=$NDK_TOOL_DIR/x86/i686-linux-androideabi/bin:$NDK_TOOL_DIR/x86/bin:$PATH \
...
if [ ! -d "$TARGET_DIR/x86_64" ]; then
  PATH=$NDK_TOOL_DIR/x86_64/x86_64-linux-androideabi/bin:$NDK_TOOL_DIR/x86_64/bin:$PATH \
